        ...
        <ul>
            <?php 
                for($page=1;$page<=$number_of_pages;$page++){       
                    echo '<li class=""> <a class="" href="view-music-ads.php?page='.$page.'&search='.$search.'&city='.$city.'&tag1='.$tag1.'&tag2='.$tag2.'&tag3='.$tag3.'&tag4='.$tag4.'&tag5='.$tag5.'&tag6='.$tag6.'&tag7='.$tag7.'&tag8='.$tag8.'&tag9='.$tag9.'&categoryId='.$categoryId.' ">'.$page.'</a></li>';
                }
            ?>
        </ul>
    </div>
